...
\begin{frame}{Results on ImageNet-1k val (500 images)}
  ...
  \vfill
  \includegraphics[width=\linewidth]{rd_curves_slide.png}

  \vfill
  {\tiny smaller ft number = more bits = better; full 5-point, 7-metric figure in the report}
\end{frame}
...
\begin{frame}{Possible improvements \& conclusion}
  ...
  \end{itemize}
  \medskip
  \textbf{Conclusion}: AEIC runs on ImageNet-1k with only 5 minor code changes and keeps its
