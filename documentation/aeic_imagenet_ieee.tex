...
\begin{table}[t]
\caption{AEIC-SE on 500 ImageNet-1k validation images (shorter side $\geq$ 256\,px), ordered by increasing bitrate, plus a JPEG baseline at its lowest quality setting. PSNR in dB; KID is the mean of the unbiased estimate (subset size 50).}
\label{tab:results}
\centering
\footnotesize
